...
|--------|---------|----------|
| IntelliJ | v0.1.25 | [copilot-code-review-0.1.25.zip](https://github.com/mystictraveler/copilot-code-review-plugins/releases/download/intellij-v0.1.25/copilot-code-review-0.1.25.zip) |
